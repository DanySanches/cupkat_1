...
model = tensorflow.keras.models.load_model(r'src\bot\assets\model_files\chatbot_model.h5')

# Carregue os arquivos de dados
intents = json.loads(open(r'src\bot\assets\chatbot_corpus\intents.json').read())
words = pickle.load(open(r'src\bot\assets\chatbot_corpus\words.pkl','rb'))
classes = pickle.load(open(r'src\bot\assets\chatbot_corpus\classes.pkl','rb'))
